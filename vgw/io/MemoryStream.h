...
namespace vgw {
    namespace io {
        ...
        public:
            ...
            inline MemoryStream(int capacity) 
                : _expandable(true)
                , _disposed(false)
                , _position(0)
                , _length(0)
            ...
            inline MemoryStream(const std::shared_ptr<Byte>& buffer, int count) 
                : _expandable(false)
                , _disposed(false)
                , _position(0)
                , _length(count)
        ...
        public:
            virtual bool                        CanSeek() override { return true; }
            virtual bool                        CanRead() override { return true; }
            virtual bool                        CanWrite() override { return true; }

        public:
            virtual int                         GetPosition() override { return this->_position; }
            virtual int                         GetLength() override { return this->_length; }
            virtual int                         GetCapacity() { return this->_capacity - this->_length; }

        public:         
            virtual bool                        Seek(int offset, SeekOrigin loc) override {
                if (this->_disposed) {
                    return false;
                }
                switch (loc) {
            ...
            virtual bool                        SetPosition(int position) override { return this->Seek(position, SeekOrigin::Begin); }
            virtual bool                        SetLength(int value) override {
                if (this->_disposed) {
                    return false;
                }
                if (value < 0) {
            ...
            virtual bool                        SetCapacity(int value) {
                if (this->_disposed) {
                    return false;
                }
        ...
        public:
            virtual bool                        WriteByte(Byte value) override {
                if (this->_disposed) {
                    return false;
                }
            ...
            virtual bool                        Write(const void* buffer, int offset, int count) override {
                if (this->_disposed) {
                    return false;
                }
                if (NULL == buffer) {
        ...
        public:
            ...
            virtual int                         Read(const void* buffer, int offset, int count) override {
                if (this->_disposed) {
                    return -1;
                }
                if (NULL == buffer) {
        ...
        public:
            inline std::shared_ptr<Byte>        GetBuffer() const { return this->_buffer; }
            inline std::shared_ptr<Byte>        ToArray(int& length) {
                length = this->_length;
                if (length <= 0) {
                    return NULL;
                }
        ...
        private:
            inline std::shared_ptr<Byte>        NewBuffer(int length) {
                if (length <= 0) {
                    return NULL;
                }
                return make_shared_alloc<Byte>(length);
            }
            inline bool                         EnsureCapacity(int value) {
                if (value < 0) {
                    return false;
                }
